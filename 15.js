...
// 3. git push // отправка данных на удаленных репозиторий
// git pull - чтобы добавить изменения в гитхабе в вижуал студио, получение данных с удаленного репозитория
// git status - статус текущего локального репозитория, какое файлы
